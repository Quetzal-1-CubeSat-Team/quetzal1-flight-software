...
* Unported License (https://creativecommons.org/licenses/by-sa/3.0/legalcode).
*
			                ...
			                usart0_t usart0, twi_t twi)
{
	...
	// MODIFICADO POR ALDO AGUILAR (07-05-2019) PARA CORRER LIBRERIA EN ARDUINO MEGA 2560
